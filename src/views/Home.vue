<template>
  <div class="root">
    <button :class="['millisecond-toggler', {'millisecond-toggler--dark': isDarkTheme}]" @click="toggleMilliseconds">{{ withMilliseconds ? 'Hide' : 'Show' }} ms</button>
...
export default defineComponent({
  ...
  methods: {
    ...
    toggleMilliseconds() {
      this.withMilliseconds = !this.withMilliseconds;
      localStorage.setItem('withMilliseconds', `${this.withMilliseconds}`);
    },
  },
  computed: {
    formattedDate() {
...
.millisecond-toggler {
  ...
  width: 150px;
  height: 50px;
  box-shadow: inset 0px 0px 2px rgb(255 255 255 / 70%);
  text-shadow: 1px 1px 2px rgb(53 53 53 / 30%);
  color: #202023;
